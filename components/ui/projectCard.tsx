...
const ProjectCard: React.FC<ProjectCardProps> = ({ id, image, title }) => {
  return (
    <Link href={`/projects/${id}`} className="flex items-start flex-col gap-2 w-full h-full justify-center">
